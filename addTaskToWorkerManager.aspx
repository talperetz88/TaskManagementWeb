<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addTaskToWorkerManager.aspx.cs" Inherits="addTaskToWorker" %>
...
<body dir="rtl">
    ...
    <div><h2>הוספת מטלה לעובד</h2></div>        
        ...
        <asp:DropDownList ID="Dr1" runat="server" CssClass="input" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="Name">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:loginConnectionString1 %>" SelectCommand="SELECT [Name] FROM [Table1]">
            </asp:SqlDataSource>
        </div>
        <div style="padding:15px 25px 10px">
